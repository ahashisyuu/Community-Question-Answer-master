...
result_data_file_2016 = "../SemEval2016-Task3-CQA-QL-test.txt"
result_data_file_2017 = "../SemEval2017-Task3-CQA-QL-test.txt"
...
load_model_dir = '../torch_file/model_2017-12-30/loss0.4143_acc1.0_497'
...
def get_args():
    ...
    parser.add_argument('--pos_h5', type=str, default=pos_h5)
